...
CURATED: dict[tuple[str, str], list[tuple[str, str]]] = {
    ...
    # Thailand — online gambling is grey-market here, so lead with the two huge
    # verticals (casino/slots + football betting). Thai-language SERPs.
    ("TH", "casino"): _kw("th",
        "คาสิโนออนไลน์", "เว็บคาสิโนออนไลน์", "คาสิโนออนไลน์เว็บตรง",
        "คาสิโนออนไลน์ได้เงินจริง", "รีวิวคาสิโนออนไลน์", "อันดับเว็บคาสิโน",
        "สล็อตออนไลน์", "เว็บสล็อตออนไลน์", "สล็อตเว็บตรง",
        "บาคาร่าออนไลน์", "รูเล็ตออนไลน์", "เว็บพนันออนไลน์"),
    ("TH", "sportsbook"): _kw("th",
        "แทงบอลออนไลน์", "เว็บแทงบอล", "พนันบอลออนไลน์", "เว็บพนันบอล",
        "แทงบอลเว็บตรง", "เว็บแทงบอลที่ดีที่สุด", "ราคาบอลวันนี้",
        "ทีเด็ดบอล", "วิเคราะห์บอล", "แทงบอลออนไลน์ได้เงินจริง"),
    ("TH", "poker"): _kw("th",
        "โป๊กเกอร์ออนไลน์", "เว็บโป๊กเกอร์", "ป๊อกเด้งออนไลน์",
        "ไพ่ออนไลน์ได้เงินจริง", "เกมไพ่ออนไลน์"),
