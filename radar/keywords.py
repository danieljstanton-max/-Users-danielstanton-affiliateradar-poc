...
CURATED: dict[tuple[str, str], list[tuple[str, str]]] = {
    ("GB", "bingo"): [("best online bingo uk", "en"), ("online bingo rooms", "en"),
                      ("online bingo bonus", "en"), ("best online bingo", "en"),
                      ("new bingo sites uk", "en"), ("best bingo sites uk", "en"),
                      ("free bingo no deposit", "en"),
                      ("bingo welcome offer", "en"), ("best bingo bonuses uk", "en"),
                      ("online bingo real money", "en"), ("new bingo sites 2025", "en"),
                      ("bingo sites with free spins", "en"), ("mobile bingo apps uk", "en"),
                      ("slingo sites uk", "en"), ("90 ball bingo online", "en")],
    ("GB", "poker"): [("best poker sites uk", "en")],
